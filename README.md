...
| layout | `header-content-footer`, `page-header`, `page-layout`, `split-layout`, `sidebar`, `card-layout`, `centered-layout`, `dialog-layout`, `page`, `detail-page`, `detail-header`, `section-heading`, `section`, `description-list` |
| docs | `skill` |

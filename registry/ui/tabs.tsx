 ...
 *
 * The active value is the caller's `value` when given, and this component's
 * own state otherwise (see `tabs-base.ts`). Unselected panes unmount, as they
 * do under radix without `forceMount`.
 */

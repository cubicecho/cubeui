...
function Nav({ nav, label, className }: NavProps) {
  ...
  return (
    <View role="navigation" testID="top-bar-layout-nav" aria-label={label} className={NAV}>
      <ScrollView
        horizontal
...
export function TopBarLayout({
  ...
  return (
    <HeaderContentFooter
      ...
      scroll={SCROLL}
      className={cn(Platform.select({ web: undefined, default: "h-full" }), className)}

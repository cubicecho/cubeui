...
colour display parts, the removable badge, the copy button, the menu, the theme picker, and the file picker (its native half only draws the zone), which each say so. Everything else here is a DOM

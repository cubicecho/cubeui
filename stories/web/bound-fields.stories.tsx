...
/**
 * The colour field is still a control the field shell reached: the id landed on the hex box, and
 * a swatch writes through to it.
 */
export const TheColourFieldIsARealControl: Story = {
  play: async ({ canvas }) => {
    ...
    await waitFor(() => expect(hex).toHaveValue("#f59e0b"));
  },
};
...
export const SubmittingCarriesEveryValue: Story = {
  ...
  play: async ({ canvas, args }) => {
    ...
    await userEvent.click(canvas.getByRole("radio", { name: "#10b981" }));

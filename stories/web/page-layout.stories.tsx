...
const Rows = ({ count = 40 }: { count?: number }) => (
  // The list resets are spelled out: the story harness has no preflight, so a bare `<ul>` keeps the
  // browser's 40px indent and the rows would not start where the title does.

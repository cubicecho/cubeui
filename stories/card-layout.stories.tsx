...
export const TitleOnly: Story = {
  args: { title: "Categories", children: <Rows /> },
...
/**
 * `empty` replaces the body when `children` are empty — and `[].map(…)` is an empty array, not
 * null, which is why the shell counts children instead of testing them for truth. The call site

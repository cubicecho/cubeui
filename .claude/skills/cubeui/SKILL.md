...
**The skill is [registry/skill/SKILL.md](../../../registry/skill/SKILL.md). Read that, and the
...
- [registry/skill/forms.md](../../../registry/skill/forms.md) — `FormField`, `useAppForm` and the
  bound fields
- [registry/skill/controls.md](../../../registry/skill/controls.md) — the controls

Working *on* this registry rather than with it? [AGENTS.md](../../../AGENTS.md) is the one that
governs that, and [docs/component-conventions.md](../../../docs/component-conventions.md) holds
the authoring rules.

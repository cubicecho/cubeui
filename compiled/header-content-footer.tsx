 ...
 *
 * The one place the platforms genuinely differ is the scrolling body. On the web it is a `<div>`
 * with `overflow-y-auto` and a tab stop; on device `overflow` does not scroll anything, so it is a

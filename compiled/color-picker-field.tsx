/**
 * Compiled from `registry/ui/color-picker-field.tsx` by `scripts/rn2web`.
...
import { type FieldProps, FieldWrapper, splitProps, useFieldContext, useFieldIds } from "./form";
